<template>
  <div class="bg-black flexcol gap-4 p-4 w-min">
    ...
    <base-tooltip :text="copied ? 'Copied!' : 'Click to copy!'" placement="bottom">
      <div
        class="copyButton"
        @click="copy('curl https://raw.githubusercontent.com/A-T-O-M-I-X/opal-connector/main/scripts/install.sh | sudo bash')"
      >
        <p
          class="text-left"
        >
          <strong class="text-primary-400">$ </strong> curl https://raw.githubusercontent.com/A-T-O-M-I-X/opal-connector/main/scripts/install.sh | sudo bash
        </p>
      </div>
    </base-tooltip>
    ...
    <base-tooltip :text="copied ? 'Copied!' : 'Click to copy!'" placement="bottom">
      ...
      >
        ...
        >
          ...
          <strong class="text-primary-400">> </strong> scoop install "https://raw.githubusercontent.com/A-T-O-M-I-X/opal-connector/main/scripts/opal-connector.json"
        </p>
      </div>
    </base-tooltip>
